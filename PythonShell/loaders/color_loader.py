...
def _load_colors():
    ...
    colors_file = project_root / "configs" / "colors.cfg"
    try:
        ...
        print(f"{WARN}: файл {colors_file} не найден, используются стандартные цвета.")
    except Exception as e:
        print(f"{WARN}: ошибка чтения colors.cfg ({e}). Стандартные цвета.")
    return colors
